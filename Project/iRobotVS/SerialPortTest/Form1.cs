...
namespace SerialPortTest
{
    public partial class Form1 : Form
    {
        ...
        //Function to turn right by 90 deg and stop
        ...
        //Function to turn left by 90 deg and stop
        ...
        private void moveStraight(double i)
        {
            int timeToSleep = (int)(46 * Math.Abs(i));
            Console.Out.WriteLine(timeToSleep + "millis\n");
            trysleep(2000);
            SendToSerial(203);
            trysleep(timeToSleep);
            SendToSerial(207);
